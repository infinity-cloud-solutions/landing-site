...
import { Clock, DollarSign, Users, BarChart3, Shield, TrendingUp } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      description: "Deja que la IA maneje inventarios, pedidos, citas y respuestas automáticas mientras tú te enfocas en hacer crecer tu empresa."
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description: "Automatiza procesos repetitivos y prepara tu empresa para crecer sin aumentar tus costos operativos."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-2xl border border-blue-200">
            ...
            <p className="text-sm text-gray-500 mt-3">Agenda en menos de 10 minutos • Sin presión de venta</p>
          </div>
        </div>
      </div>
    </section>
