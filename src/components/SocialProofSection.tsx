...
const SocialProofSection = () => {
  const customerArchetypes = [
    {
      type: "Dueños de tiendas/Ventas",
      icon: ShoppingCart,
      testimonial: {
        text: "Antes perdía 3 horas diarias actualizando inventario manualmente. Ahora el sistema lo hace automáticamente y tengo reportes en tiempo real. Mis ventas subieron 45% porque nunca me quedo sin mercancia.",
        name: "Carmen R.",
        business: "Tienda de Ropa, Guadalajara, Jalisco"
      }
    },
    {
      ...
      icon: Calendar,
      testimonial: {
        text: "El sistema de citas automático cambió mi vida. Los clientes reservan a todas horas, reciben recordatorios automáticos y yo me enfoco solo en dar el mejor servicio.",
        name: "Dr. Luis M.",
        business: "Clínica dental, Hermosillo, Sonora"
      }
    },
    {
      type: "Restauranteros",
      icon: Users,
      testimonial: {
        text: "La app de pedidos y el chatbot de WhatsApp manejan el 80% de nuestros pedidos sin errores. Mi personal se enfoca en el servicio y aumentamos ganancias 35%. Mis clientes están más contentos que nunca.",
        name: "Sofía T.",
        business: "Restaurante, Monterrey, Nuevo León"
      }
    },
    {
      ...
      icon: TrendingUp,
      testimonial: {
        text: "Los reportes automáticos me dan datos que nunca tuve. Sé exactamente qué productos rotan más, cuándo reordenar, y dónde están mis mejores oportunidades. Crecimos 30% en 6 meses.",
        name: "Javier L.",
        business: "Distribuidora, Culiacán, Sinaoloa"
      }
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              <h4 className="text-2xl font-bold text-orange-400 mb-1">30+</h4>
