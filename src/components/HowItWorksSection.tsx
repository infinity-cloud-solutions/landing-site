  ...
  const steps = [
    {
      ...
      description: "Analizamos tu negocio, identificamos oportunidades de automatización y diseñamos una estrategia personalizada.",
      timeframe: "Mismo día"
    },
    {
      icon: Search,
      title: "Análisis Profundo de Procesos",
      description: "Estudiamos tus flujos de trabajo actuales, puntos de fricción y oportunidades de mejora específicas.",
      timeframe: "2-3 días"
    },
    {
      icon: Cog,
    ...
    },
    {
      ...
      description: "Instalamos todo, capacitamos a tu equipo y nos aseguramos de que funcione perfectamente desde día 1.",
      timeframe: "1 semana"
    }
  ];
