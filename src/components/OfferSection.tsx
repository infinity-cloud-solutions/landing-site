...
const OfferSection: React.FC<OfferSectionProps> = ({ onContactClick }) => {
  return (
    <section className="py-20 bg-gradient-to-r from-orange-700 to-orange-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 mb-8">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-3">
                <CheckCircle className="text-green-300 flex-shrink-0 mt-1" size={24} />
                <div className="text-left">
                  <h4 className="font-bold mb-1">Plan de trabajo de implementación</h4>
          ...
          {/* Urgency */}
          <div className="mt-8 bg-red-800 bg-opacity-20 border border-red-600 border-opacity-30 rounded-lg p-4">
            <p className="text-red-200 font-semibold">
              ⚠️ <strong>Solo 8 consultas disponibles este mes</strong> - Agenda la tuya antes de que se agoten
            </p>
          </div>
        </div>
      </div>
