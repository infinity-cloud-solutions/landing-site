...
const ProofSection = () => {
  const testimonials = [
    {
      text: "En 8 semanas automatizamos todo el inventario. Ahora trabajo 15 horas menos y vendemos 40% más.",
      name: "Carlos M.",
      business: "Tienda de electrónicos"
    },
    {
      text: "El chatbot responde el 100% de preguntas de WhatsApp. Mis clientes están más contentos y yo tengo más tiempo libre.",
      name: "María L.",
      business: "Consultorio dental"
    },
    {
      text: "La app de pedidos cambió nuestro restaurante. Cero errores, menos trabajo manual, más ganancias.",
      name: "Roberto S.",
      business: "Restaurante familiar"
    },
    {
      text: "Me hicieron un sistema de citas automático que me ayudó a aumentar mis reservaciones sin contratar a nadie más.",
      name: "Ana P.",
    ...
    },
    {
      ...
      name: "Miguel T.",
      business: "Distribuidora de lámina"
    },
    {
      text: "El bot me filtra los prospectos que están realemnte interesados en mi producto y yo solo cierro la venta.",
      name: "Ernest R.",
      business: "Fabricante de gorras"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h4 className="text-3xl font-bold text-blue-600 mb-2">30+</h4>
          ...
          <div className="text-center">
            ...
            <h4 className="text-3xl font-bold text-purple-600 mb-2">20+ horas</h4>
