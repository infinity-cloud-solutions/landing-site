      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Plan detallado con prioridades, cronograma y presupuesto realista</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="text-green-400 flex-shrink-0 mt-1" size={20} />
            ...
            <div className="flex items-start space-x-3">
              <CheckCircle className="text-green-400 flex-shrink-0 mt-1" size={20} />
              <div>
                <h4 className="font-semibold mb-1">Plan de trabajo de implementación</h4>
        ...
        <div className="mt-8 bg-red-600 bg-opacity-30 border border-red-400 border-opacity-50 rounded-lg p-4">
          <p className="text-red-200 font-semibold">
            🔥 <strong>Últimas 8 consultas disponibles este mes</strong> - No esperes: estás dejando de ganar tiempo y dinero
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center items-center space-x-8 opacity-60">
            ...
            <span className="text-gray-400">+ HiBerry</span>
            <span className="text-gray-400">+ Restaurante Casa María</span>
            <span className="text-gray-400">+ 26 más...</span>
          </div>
        </div>
      </div>
    </section>
