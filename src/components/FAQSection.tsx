  ...
  const faqs = [
    {
      ...
      answer: "El costo varía según tus necesidades específicas, pero la mayoría de nuestros clientes recuperan su inversión en 2-3 meses. Durante la consulta gratuita calculamos el ROI exacto para tu caso. Lo importante es que cada peso invertido se traduce en múltiples pesos ahorrados y ganados."
    },
    {
    ...
    },
    {
      ...
      answer: "Soporte ilimitado está incluido siempre. No te abandonamos después de entregar - estamos contigo para ajustes, mejoras, preguntas y nuevas necesidades. Tu éxito es nuestro éxito a largo plazo."
    },
    {
      question: "¿Cómo sé que esto no es otra promesa vacía?",
      answer: "Simple: la consulta es 100% gratuita y sin compromiso. Analizamos tu negocio, te mostramos exactamente qué automatizar y cómo, calcularemos tu ROI, y te daremos una estrategia completa. Si no ves valor inmediato, no hay presión de continuar."
    }
  ];
