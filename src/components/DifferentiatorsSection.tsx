...
const DifferentiatorsSection = () => {
  const differentiators = [
    ...
    },
    {
      ...
      description: "Trabajas directamente con el desarrollador. Sin intermediarios, sin call centers, sin esperas interminables."
    },
    {
      icon: Rocket,
      title: "Implementación Rápida y Efectiva",
      description: "Mientras otros tardan meses, nosotros entregamos resultados funcionando en 2-4 semanas máximo."
    },
    {
      icon: Eye,
      title: "Transparencia Total del Proceso",
      description: "Ves el progreso día a día, entiendes cada decisión técnica, y tienes control total sobre tu inversión."
    },
    {
      icon: Users,
      title: "Soporte Ilimitado Post-Entrega",
      description: "No te abandonamos después de entregar. Ajustes, mejoras y soporte técnico incluidos sin costo extra."
    },
    {
      icon: Zap,
  ...
  const comparison = [
    ...
    {
      feature: "Soporte Ilimitado",
      us: true,
      them: false
    },
    {
      feature: "Entrega en 2-4 Semanas",
      us: true,
      them: false
    },
    {
      feature: "Contacto Directo con Desarrollador",
      us: true,
      them: false
    },
    {
